...
export const mockAssignedCases: AssignedCase[] = [
  ...
  {
    case_id: "CA-2026-0006",
    title: "브런치 콘서트 단체 예매 절차 문의",
    received_at: "2026-06-07",
    category: "문화관광",
    region: "광주광역시 동구",
    priority: "보통",
    status: "미처리",
    assignee: "문화행사팀",
    raw_text:
      "기관 문화행사로 직원 20명이 브런치 콘서트를 관람하려고 합니다. 티켓 오픈 전에 단체로 미리 예매할 수 있는지, 홈페이지 예매 매수 제한이 있으면 콜센터나 현장 예매로 처리할 수 있는지 안내를 요청합니다.",
    summary: "브런치 콘서트 단체 사전 예매 가능 여부와 예매 경로 안내 요청",
    request_segments: [
      "단체 사전 예매 가능 여부 안내 요청",
      "홈페이지 예매 매수 제한 확인 요청",
      "콜센터 또는 현장 예매 절차 안내 요청",
    ],
    structured: {
      observation: { text: "기관 단체 20명이 브런치 콘서트 관람을 계획하고 있음" },
      result: { text: "티켓 오픈 전 사전 예매 가능 여부와 예매 경로가 불명확함" },
      request: { text: "단체 사전 예매 가능 여부, 예매 매수 제한, 콜센터 또는 현장 예매 절차 안내 요청" },
      context: { text: "문화행사 단체 관람 준비를 위해 예산과 좌석 확보 가능성을 확인해야 함" },
    },
  },
  {
    case_id: "CA-2026-0007",
    title: "외국인 방문객 영어 가이드 투어 신청 문의",
    received_at: "2026-06-07",
    category: "문화관광",
    region: "광주광역시 동구",
    priority: "보통",
    ...
    assignee: "관람지원팀",
    raw_text:
      "국제회의 참석 외국인 전문가 5명을 모시고 국립아시아문화전당을 방문할 예정입니다. 영어 해설이 가능한 가이드 투어가 있는지, 신청 마감일과 신청 경로, 잔여석이 없을 때 대안이 있는지 안내를 부탁드립니다.",
    summary: "외국인 방문객 영어 가이드 투어 운영 여부와 신청 조건 안내 요청",
    request_segments: [
      "영어 가이드 투어 운영 여부 안내 요청",
      "신청 마감일 안내 요청",
      "신청 경로 안내 요청",
      "잔여석 부족 시 대안 안내 요청",
    ],
    structured: {
      observation: { text: "국제회의 참석 외국인 전문가 5명이 전당 방문을 예정하고 있음" },
      result: { text: "영어 해설 투어 가능 여부와 신청 조건을 사전에 확인해야 함" },
      request: { text: "영어 가이드 투어 운영 여부, 신청 기한, 신청 경로, 잔여석 부족 시 대안 안내 요청" },
      context: { text: "방문 일정 확정을 위해 외국어 해설 프로그램 이용 가능성을 확인하는 민원" },
    },
  },
  {
    case_id: "CA-2026-0008",
    title: "근린공원 야간 조명 고장 복합 신고",
    received_at: "2026-06-07",
    category: "안전",
    region: "대전광역시 서구",
    priority: "급함",
    ...
    assignee: "공원녹지과",
    raw_text:
      "근린공원 산책로 조명 여러 개가 꺼져 야간 이용 시 불안합니다. 조명 점검과 교체 일정을 알려주시고, 어두운 구간에는 임시 조치를 해 주시기 바랍니다.",
    summary: "공원 야간 조명 고장에 대한 점검, 교체 일정, 임시 조치 요청",
    request_segments: [
      "공원 산책로 조명 점검 요청",
      "고장 조명 교체 일정 안내 요청",
      "어두운 구간 임시 안전 조치 요청",
    ...
    structured: {
      observation: { text: "근린공원 산책로 조명 다수가 꺼져 있음" },
      result: { text: "야간 보행 불안과 안전사고 우려가 있음" },
      request: { text: "조명 점검, 교체 일정 안내, 어두운 구간 임시 조치 요청" },
      context: { text: "야간 이용객 안전 확보를 위한 시설 점검과 임시 조치가 필요함" },
    },
  },
  {
    case_id: "CA-2026-0009",
    title: "사회적기업 인증 절차와 제출 서류 문의",
    received_at: "2026-06-07",
    category: "복지",
    region: "서울특별시 중구",
    priority: "보통",
    ...
    assignee: "일자리정책과",
    raw_text:
      "사회적기업 인증을 준비 중입니다. 인증 절차와 필수 제출 서류를 알고 싶고, 예비사회적기업과 인증사회적기업의 차이, 사전 상담 방법도 함께 안내해 주세요.",
    summary: "사회적기업 인증 절차, 제출 서류, 제도 차이와 상담 방법 안내 요청",
    request_segments: [
      "사회적기업 인증 절차 안내 요청",
      "필수 제출 서류 안내 요청",
      "예비사회적기업과 인증사회적기업 차이 안내 요청",
      "사전 상담 방법 안내 요청",
    ],
    structured: {
      observation: { text: "민원인이 사회적기업 인증 준비 중임" },
      result: { text: "인증 절차와 제출 서류, 제도 구분에 대한 정보가 필요함" },
      request: { text: "사회적기업 인증 절차, 필수 제출 서류, 예비사회적기업과 인증사회적기업 차이, 상담 방법 안내 요청" },
      context: { text: "신청 전 준비사항과 상담 경로를 확인하려는 민원" },
    },
  },
];
