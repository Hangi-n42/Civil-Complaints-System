    ...
    def _build_instruction_block(
        ...
        *,
        ...
        citation_rules = (
            ...
            "- The answer must end with the official closing sentence '감사합니다.' and no source-token lines may follow it.\n"
        )
        ...
        if has_raw_complaint:
            complaint_rules = (
                ...
                "  3. <write the case-specific reply here>\n"
                "  4. 답변 내용에 대한 추가 설명이 필요한 경우 담당부서로 문의해 주시면 세부 검토 결과와 후속 절차를 친절히 안내해 드리겠습니다. 감사합니다.\n"
    ...
    def build(
        ...
        *,
        ...
        example_json = (
            ...
            "\"relevance_score\":0.9"
            "}],"
            "\"answer\":\"1. 귀하께서 신청하신 민원에 대한 검토 결과를 다음과 같이 답변드립니다.\\n\\n2. 귀하의 민원 내용은 제기하신 불편 사항에 대한 검토 및 조치 요청으로 이해됩니다. 접수된 민원 취지와 관련 근거를 함께 고려하여 처리 방향을 검토하는 사안입니다.\\n\\n3. 접수하신 사항은 관리비 이의제기 처리 절차와 현장 확인이 필요한 사항으로 구분하여 검토할 수 있습니다. 담당부서에서는 접수 자료를 확인한 뒤 필요한 경우 관계 부서 협의 또는 현장 확인을 거쳐 처리 가능 여부와 후속 절차를 안내드리겠습니다.\\n\\n4. 답변 내용에 대한 추가 설명이 필요한 경우 담당부서로 문의해 주시면 세부 검토 결과와 후속 절차를 친절히 안내해 드리겠습니다. 감사합니다.\","
        ...
        return (
            ...
            + "answer는 '감사합니다.'으로 마치며 그 뒤에 '끝.', 출처 토큰, 다른 문장을 쓰지 마세요. "
