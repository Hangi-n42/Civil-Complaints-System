...
| PublicAgencyInsight | required_aspect_hit_rate | 0.846 |
| PublicAgencyInsight | required_action_type_hit_rate | 0.615 |
...
| PublicAgencyInsight | avg_actionability_score | 0.815 |
| PublicAgencyInsight | pii_leak_rate | 0.000 |
| PublicAgencyInsight | forbidden_ai_ops_term_rate | 0.000 |
| LLM | direct_llm_success_count | 10 |
| LLM | fallback_count | 1 |
| LLM | fallback_rate | 0.091 |
| LLM | direct_llm_success_rate | 0.909 |
...
| LLM | avg_llm_duration_ms | 148790.3 |
...
| 복지 지원 기준/신청 절차 불편 반복 | False | 3 | PUBLIC_GUIDANCE_NEEDED | HUMAN_REVIEW_REQUIREMENT_FAILED |
| 악취/냄새/하수 민원 야간 집중 | False | 1 | HOTSPOT_RESPONSE_REQUIRED | REQUIRED_ACTION_TYPE_MISSING |
| 공공자전거/앱 예약·대여 UX 불편 | True | 3 | ACCESSIBILITY_OR_USABILITY_ISSUE | - |
| 부서 처리 지연/미처리 누적 | False | 2 | PROCESS_DELAY_RISK | REQUIRED_ACTION_TYPE_MISSING |
| 재민원/반복 민원 증가 | False | 1 | REOPEN_OR_REPEAT_RISK | REQUIRED_ASPECT_MISSING, REQUIRED_ACTION_TYPE_MISSING |
| 소음/공사 민원 특정 시간대 집중 | False | 2 | RECURRING_COMPLAINT_PATTERN | REQUIRED_ASPECT_MISSING, REQUIRED_ACTION_TYPE_MISSING |
| 접근성/고령자·장애인 이용 어려움 | True | 4 | SERVICE_DESIGN_IMPROVEMENT | - |
| 가로등/보안등 고장 반복 | False | 2 | RECURRING_COMPLAINT_PATTERN | REQUIRED_ACTION_TYPE_MISSING |
