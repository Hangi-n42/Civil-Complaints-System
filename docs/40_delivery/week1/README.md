...
- [x] 임베딩 후보 비교 계획 수립
	- 산출물: [docs/20_domains/retrieval/embedding_comparison.md](../../20_domains/retrieval/embedding_comparison.md)
- [x] ChromaDB/FAISS 비교 및 1차 선택안 제시
	- 산출물: [docs/20_domains/retrieval/vectordb_comparison.md](../../20_domains/retrieval/vectordb_comparison.md)
- [x] 검색 메타데이터 키 정의
	- 산출물: [docs/20_domains/retrieval/metadata_schema.md](../../20_domains/retrieval/metadata_schema.md)
- [x] 청크 메타데이터 구조 초안
	- 산출물: [docs/20_domains/retrieval/chunk_schema.md](../../20_domains/retrieval/chunk_schema.md)
- [x] Ollama 설치/로컬 실행/연동 가능 여부 확인
	- 산출물: [docs/20_domains/retrieval/ollama_setup_note.md](../../20_domains/retrieval/ollama_setup_note.md)
- [x] RAG API 입력/출력 초안 및 스키마 반영
	- 산출물: [docs/10_contracts/api/api_spec.md](../../10_contracts/api/api_spec.md), [docs/10_contracts/schema/schema_contract.md](../../10_contracts/schema/schema_contract.md)

### 2) 협업 정리 상태

- [x] FE 요구 검색 카드 필드 반영 완료
	- 필수 필드: `doc_id`, `score`, `title`, `snippet`
	- 반영 근거: [docs/10_contracts/api/api_spec.md](../../10_contracts/api/api_spec.md)
- [x] BE3 통합 QA 응답 포맷 반영 완료
	- 상태값, citation 토큰, error/meta/validation 구조 반영
	- 반영 근거: [docs/10_contracts/interfaces/be3_fe_be2_unified_spec.md](../../10_contracts/interfaces/be3_fe_be2_unified_spec.md), [docs/10_contracts/interfaces/be2_be3_interface.md](../../10_contracts/interfaces/be2_be3_interface.md)
