...
- [x] 구조화 결과 validation 항목 정의
  - 근거: docs/20_domains/generation/be3_validation_rules.md
- [x] validation 오류 코드 초안 작성
  - 근거: docs/20_domains/generation/be3_error_codes.md
- [x] validation 결과 포맷 초안 정리
  - 근거: docs/20_domains/generation/be3_validation_format.md
- [x] JSON 파싱 실패 유형 조사 및 분류
  - 근거: docs/20_domains/generation/be3_json_parse_failures.md
- [x] JSON 파싱 재시도 전략 초안 작성
  - 근거: docs/20_domains/generation/be3_json_retry_strategy.md
- [x] `confidence`, `evidence_span`, `citations` 등 핵심 필드 검증 규칙 정리
  - 근거: docs/20_domains/generation/be3_validation_rules.md, docs/20_domains/generation/be3_validation_format.md
- [x] 4-bit/8-bit 비교 시 측정할 항목 정의
  - 근거: docs/20_domains/generation/be3_perf_oom_baseline.md(항목/템플릿 정의만 했고 실험 실행은 아직 아님)
- [x] 응답 시간/메모리 로깅 기준 정의
  - 근거: docs/20_domains/generation/be3_perf_oom_baseline.md
- [x] OOM 발생 시 대응 흐름 초안 작성
  - 근거: docs/20_domains/generation/be3_perf_oom_baseline.md
- [x] FE/BE2에 전달할 error/citation/validation 표시용 데이터 형식 정리
  - 근거: docs/20_domains/generation/be3_validation_format.md, docs/20_domains/generation/be3_error_codes.md, docs/20_domains/generation/be3_json_parse_failures.md
